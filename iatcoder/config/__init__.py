...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "iatcoder" / "config.toml"
PROJECT_CONFIG_NAME = ".iatcoder.toml"
...
ENV_PROVIDER = "IATCODER_PROVIDER"
ENV_API_KEY = "IATCODER_API_KEY"
ENV_BASE_URL = "IATCODER_BASE_URL"
ENV_MODEL = "IATCODER_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("IATCODER_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("IATCODER_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("IATCODER_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
        ...
        "base_url": (
            "IATCODER_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("IATCODER_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("IATCODER_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "IATCODER_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("IATCODER_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("IATCODER_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("IATCODER_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid Iatcoder config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read Iatcoder config file {path}: {exc}") from exc
