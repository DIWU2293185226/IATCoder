...
SKILL_FILE_CREATION_GUIDE = """When creating Iatcoder skill files at .iatcoder/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${IATCODER_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".iatcoder" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".iatcoder" / "skills", "project"),
    ]
