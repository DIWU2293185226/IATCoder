...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available Iatcoder skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a Iatcoder skill."),
    ...
    SlashCommand("exit", "/exit", "Exit Iatcoder.", ("quit",)),
)
